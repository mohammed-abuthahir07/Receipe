...
{
    $hasRating = $recipe['avg_rating'] !== null && (float) $recipe['avg_rating'] > 0;
    $rating = $hasRating ? number_format((float) $recipe['avg_rating'], 1) : null;
    $total = (int) $recipe['prep_time_mins'] + (int) $recipe['cook_time_mins'];
    $description = repair_text((string) $recipe['description']);
    ?>
    <article class="recipe-card" data-reveal>
        <a class="recipe-card__media" href="<?= e(url('recipe.php?slug=' . $recipe['slug'])) ?>">
            <img src="<?= e($recipe['hero_image_url']) ?>" alt="<?= e($recipe['title']) ?>" width="400" height="300" loading="lazy" decoding="async">
        ...
        <div class="recipe-card__body">
            ...
            <p class="recipe-card__desc"><?= e(mb_strimwidth($description, 0, 90, '…')) ?></p>
