...
<article data-recipe data-recipe-id="<?= (int) $recipe['id'] ?>" data-servings="<?= (int) $recipe['servings'] ?>">
    <section class="recipe-hero">
        <img data-parallax src="<?= e($recipe['hero_image_url']) ?>" alt="<?= e($recipe['title']) ?>">
        ...
        <div class="recipe-hero__content">
            ...
            <div class="chip-row">
                <span class="chip badge-inline <?= e(food_type_class($recipe['food_type'])) ?>" style="position:static"><?= e(food_type_label($recipe['food_type'])) ?></span>
                ...
                <span class="chip">★ <?= e((string) ($rating ?? 'New')) ?></span>
            </div>
            ...
            <div class="engagement">
                ...
                <button class="btn btn--ghost" data-action="favorite" data-pop type="button">Save</button>
                <button class="btn btn--ghost" data-action="like" data-pop type="button">Like</button>
                <button class="btn btn--ghost" data-action="cooked" type="button">I cooked this</button>
    ...
    <div class="container recipe-layout">
        <div>
            ...
            <?php if ($nutrition): ?>
            <section class="panel" style="margin-top:1rem" data-reveal>
                <h2>Nutrition <small style="color:var(--muted);font-weight:400">(per serving)</small></h2>
                <div class="nutrition-grid">
                    ...
                    <div><span>Fiber</span><strong><?= e(format_qty($nutrition['fiber_g'])) ?>g</strong></div>
                    <?php endif; ?>
            ...
            <section class="panel" style="margin-top:1rem" data-reveal>
                ...
                <?php if (is_logged_in()): ?>
                    <form method="post" style="margin-bottom:1rem">
                        <div class="form-field">
                            <textarea name="comment_body" rows="3" placeholder="Share a tip or ask a question…" required></textarea>
                        </div>
                ...
                <?php foreach ($comments as $comment): ?>
                    <div style="padding:.8rem 0;border-bottom:1px solid rgba(15,47,36,.08)">
                        <strong><?= e($comment['user_name']) ?></strong>
                        <?php if ($comment['is_author_reply']): ?>
                            <span class="chip badge-inline" style="background:var(--leaf-soft);color:var(--leaf)">Author</span>
                        <?php endif; ?>
                        <p><?= e($comment['body']) ?></p>
                    </div>
                <?php endforeach; ?>
    ...
    <section class="section" style="padding-top:0">
        <div class="container">
            <div class="section__head">
                ...
                <p>More from <?= e($recipe['cuisine_name']) ?> cuisine.</p>
            </div>
